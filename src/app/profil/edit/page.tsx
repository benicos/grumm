    ...
    <div className="grid gap-5 lg:grid-cols-2">
      ...
      >
        ...
        <button
          ...
          className="mt-5 w-full rounded-md bg-[#ffd166] px-4 py-3 text-sm font-extrabold text-[#07111f] transition hover:bg-[#ffe08f] disabled:cursor-not-allowed disabled:opacity-60"
        >
          {isSubmitting === "settings" ? "Mise a jour..." : "Mettre a jour"}
        </button>
      </form>
